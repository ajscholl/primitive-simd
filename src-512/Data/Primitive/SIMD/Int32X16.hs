...
-- ** Int32X16
data Int32X16 = Int32X16 Int32X16# deriving Typeable
...
packInt32X16 (I32# x1, I32# x2, I32# x3, I32# x4, I32# x5, I32# x6, I32# x7, I32# x8, I32# x9, I32# x10, I32# x11, I32# x12, I32# x13, I32# x14, I32# x15, I32# x16) = Int32X16 (packInt32X16# (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #))
...
unpackInt32X16 (Int32X16 m1) = case unpackInt32X16# m1 of
    (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #) -> (I32# x1, I32# x2, I32# x3, I32# x4, I32# x5, I32# x6, I32# x7, I32# x8, I32# x9, I32# x10, I32# x11, I32# x12, I32# x13, I32# x14, I32# x15, I32# x16)

{-# INLINE unsafeInsertInt32X16 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertInt32X16 :: Int32X16 -> Int32 -> Int -> Int32X16
unsafeInsertInt32X16 (Int32X16 m1) (I32# y) _i@(I# ip) = Int32X16 (insertInt32X16# m1 y (ip -# 0#))
...
plusInt32X16 (Int32X16 m1_1) (Int32X16 m1_2) = Int32X16 (plusInt32X16# m1_1 m1_2)

{-# INLINE minusInt32X16 #-}
-- | Subtract two vectors element-wise.
minusInt32X16 :: Int32X16 -> Int32X16 -> Int32X16
minusInt32X16 (Int32X16 m1_1) (Int32X16 m1_2) = Int32X16 (minusInt32X16# m1_1 m1_2)

{-# INLINE timesInt32X16 #-}
-- | Multiply two vectors element-wise.
timesInt32X16 :: Int32X16 -> Int32X16 -> Int32X16
timesInt32X16 (Int32X16 m1_1) (Int32X16 m1_2) = Int32X16 (timesInt32X16# m1_1 m1_2)

{-# INLINE quotInt32X16 #-}
-- | Rounds towards zero element-wise.
quotInt32X16 :: Int32X16 -> Int32X16 -> Int32X16
quotInt32X16 (Int32X16 m1_1) (Int32X16 m1_2) = Int32X16 (quotInt32X16# m1_1 m1_2)

{-# INLINE remInt32X16 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt32X16 :: Int32X16 -> Int32X16 -> Int32X16
remInt32X16 (Int32X16 m1_1) (Int32X16 m1_2) = Int32X16 (remInt32X16# m1_1 m1_2)

{-# INLINE negateInt32X16 #-}
-- | Negate element-wise.
negateInt32X16 :: Int32X16 -> Int32X16
negateInt32X16 (Int32X16 m1_1) = Int32X16 (negateInt32X16# m1_1)

{-# INLINE indexInt32X16Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt32X16Array :: ByteArray -> Int -> Int32X16
indexInt32X16Array (ByteArray a) (I# i) = Int32X16 (indexInt32X16Array# a i)

{-# INLINE readInt32X16Array #-}
-- | Read a vector from specified index of the mutable array.
readInt32X16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int32X16
readInt32X16Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt32X16Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Int32X16 m1 #))

{-# INLINE writeInt32X16Array #-}
-- | Write a vector to specified index of mutable array.
writeInt32X16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int32X16 -> m ()
writeInt32X16Array (MutableByteArray a) (I# i) (Int32X16 m1) = primitive_ (writeInt32X16Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexInt32X16OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt32X16OffAddr :: Addr -> Int -> Int32X16
indexInt32X16OffAddr (Addr a) (I# i) = Int32X16 (indexInt32X16OffAddr# (plusAddr# a (i *# 64#)) 0#)

{-# INLINE readInt32X16OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt32X16OffAddr :: PrimMonad m => Addr -> Int -> m Int32X16
readInt32X16OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt32X16OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Int32X16 m1 #))

{-# INLINE writeInt32X16OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt32X16OffAddr :: PrimMonad m => Addr -> Int -> Int32X16 -> m ()
writeInt32X16OffAddr (Addr a) (I# i) (Int32X16 m1) = primitive_ (writeInt32X16OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1)
