...
-- ** Word8X32
data Word8X32 = Word8X32 Word8X32# deriving Typeable
...
unpackWord8X32 (Word8X32 m1) = case unpackWord8X32# m1 of
    (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32 #) -> (W8# x1, W8# x2, W8# x3, W8# x4, W8# x5, W8# x6, W8# x7, W8# x8, W8# x9, W8# x10, W8# x11, W8# x12, W8# x13, W8# x14, W8# x15, W8# x16, W8# x17, W8# x18, W8# x19, W8# x20, W8# x21, W8# x22, W8# x23, W8# x24, W8# x25, W8# x26, W8# x27, W8# x28, W8# x29, W8# x30, W8# x31, W8# x32)

{-# INLINE unsafeInsertWord8X32 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord8X32 :: Word8X32 -> Word8 -> Int -> Word8X32
unsafeInsertWord8X32 (Word8X32 m1) (W8# y) _i@(I# ip) = Word8X32 (insertWord8X32# m1 y (ip -# 0#))
...
plusWord8X32 (Word8X32 m1_1) (Word8X32 m1_2) = Word8X32 (plusWord8X32# m1_1 m1_2)

{-# INLINE minusWord8X32 #-}
-- | Subtract two vectors element-wise.
minusWord8X32 :: Word8X32 -> Word8X32 -> Word8X32
minusWord8X32 (Word8X32 m1_1) (Word8X32 m1_2) = Word8X32 (minusWord8X32# m1_1 m1_2)

{-# INLINE timesWord8X32 #-}
-- | Multiply two vectors element-wise.
timesWord8X32 :: Word8X32 -> Word8X32 -> Word8X32
timesWord8X32 (Word8X32 m1_1) (Word8X32 m1_2) = Word8X32 (timesWord8X32# m1_1 m1_2)

{-# INLINE quotWord8X32 #-}
-- | Rounds towards zero element-wise.
quotWord8X32 :: Word8X32 -> Word8X32 -> Word8X32
quotWord8X32 (Word8X32 m1_1) (Word8X32 m1_2) = Word8X32 (quotWord8X32# m1_1 m1_2)

{-# INLINE remWord8X32 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord8X32 :: Word8X32 -> Word8X32 -> Word8X32
remWord8X32 (Word8X32 m1_1) (Word8X32 m1_2) = Word8X32 (remWord8X32# m1_1 m1_2)

{-# INLINE indexWord8X32Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord8X32Array :: ByteArray -> Int -> Word8X32
indexWord8X32Array (ByteArray a) (I# i) = Word8X32 (indexWord8X32Array# a i)

{-# INLINE readWord8X32Array #-}
-- | Read a vector from specified index of the mutable array.
readWord8X32Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word8X32
readWord8X32Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord8X32Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word8X32 m1 #))

{-# INLINE writeWord8X32Array #-}
-- | Write a vector to specified index of mutable array.
writeWord8X32Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word8X32 -> m ()
writeWord8X32Array (MutableByteArray a) (I# i) (Word8X32 m1) = primitive_ (writeWord8X32Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexWord8X32OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord8X32OffAddr :: Addr -> Int -> Word8X32
indexWord8X32OffAddr (Addr a) (I# i) = Word8X32 (indexWord8X32OffAddr# (plusAddr# a (i *# 32#)) 0#)

{-# INLINE readWord8X32OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord8X32OffAddr :: PrimMonad m => Addr -> Int -> m Word8X32
readWord8X32OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord8X32OffAddr# (plusAddr# addr i') 0#) a ((i *# 32#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word8X32 m1 #))

{-# INLINE writeWord8X32OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord8X32OffAddr :: PrimMonad m => Addr -> Int -> Word8X32 -> m ()
writeWord8X32OffAddr (Addr a) (I# i) (Word8X32 m1) = primitive_ (writeWord8X32OffAddr# (plusAddr# a ((i *# 32#) +# 0#)) 0# m1)
