...
-- ** Word8X64
data Word8X64 = Word8X64 Word8X32# Word8X32# deriving Typeable
...
sumWord8X64 (Word8X64 x1 x2) = case unpackWord8X32# (plusWord8X32# x1 x2) of
    (# y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19, y20, y21, y22, y23, y24, y25, y26, y27, y28, y29, y30, y31, y32 #) -> W8# y1 + W8# y2 + W8# y3 + W8# y4 + W8# y5 + W8# y6 + W8# y7 + W8# y8 + W8# y9 + W8# y10 + W8# y11 + W8# y12 + W8# y13 + W8# y14 + W8# y15 + W8# y16 + W8# y17 + W8# y18 + W8# y19 + W8# y20 + W8# y21 + W8# y22 + W8# y23 + W8# y24 + W8# y25 + W8# y26 + W8# y27 + W8# y28 + W8# y29 + W8# y30 + W8# y31 + W8# y32

{-# INLINE plusWord8X64 #-}
-- | Add two vectors element-wise.
plusWord8X64 :: Word8X64 -> Word8X64 -> Word8X64
plusWord8X64 (Word8X64 m1_1 m2_1) (Word8X64 m1_2 m2_2) = Word8X64 (plusWord8X32# m1_1 m1_2) (plusWord8X32# m2_1 m2_2)

{-# INLINE minusWord8X64 #-}
-- | Subtract two vectors element-wise.
minusWord8X64 :: Word8X64 -> Word8X64 -> Word8X64
minusWord8X64 (Word8X64 m1_1 m2_1) (Word8X64 m1_2 m2_2) = Word8X64 (minusWord8X32# m1_1 m1_2) (minusWord8X32# m2_1 m2_2)

{-# INLINE timesWord8X64 #-}
-- | Multiply two vectors element-wise.
timesWord8X64 :: Word8X64 -> Word8X64 -> Word8X64
timesWord8X64 (Word8X64 m1_1 m2_1) (Word8X64 m1_2 m2_2) = Word8X64 (timesWord8X32# m1_1 m1_2) (timesWord8X32# m2_1 m2_2)

{-# INLINE quotWord8X64 #-}
-- | Rounds towards zero element-wise.
quotWord8X64 :: Word8X64 -> Word8X64 -> Word8X64
quotWord8X64 (Word8X64 m1_1 m2_1) (Word8X64 m1_2 m2_2) = Word8X64 (quotWord8X32# m1_1 m1_2) (quotWord8X32# m2_1 m2_2)

{-# INLINE remWord8X64 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord8X64 :: Word8X64 -> Word8X64 -> Word8X64
remWord8X64 (Word8X64 m1_1 m2_1) (Word8X64 m1_2 m2_2) = Word8X64 (remWord8X32# m1_1 m1_2) (remWord8X32# m2_1 m2_2)

{-# INLINE indexWord8X64Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord8X64Array :: ByteArray -> Int -> Word8X64
indexWord8X64Array (ByteArray a) (I# i) = Word8X64 (indexWord8X32Array# a ((i *# 2#) +# 0#)) (indexWord8X32Array# a ((i *# 2#) +# 1#))

{-# INLINE readWord8X64Array #-}
-- | Read a vector from specified index of the mutable array.
readWord8X64Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word8X64
readWord8X64Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord8X32Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readWord8X32Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Word8X64 m1 m2 #))

{-# INLINE writeWord8X64Array #-}
-- | Write a vector to specified index of mutable array.
writeWord8X64Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word8X64 -> m ()
writeWord8X64Array (MutableByteArray a) (I# i) (Word8X64 m1 m2) = primitive_ (writeWord8X32Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeWord8X32Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexWord8X64OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord8X64OffAddr :: Addr -> Int -> Word8X64
indexWord8X64OffAddr (Addr a) (I# i) = Word8X64 (indexWord8X32OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0#) (indexWord8X32OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0#)

{-# INLINE readWord8X64OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord8X64OffAddr :: PrimMonad m => Addr -> Int -> m Word8X64
readWord8X64OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord8X32OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readWord8X32OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 32#) s1 of
        (# s2, m2 #) -> (# s2, Word8X64 m1 m2 #))

{-# INLINE writeWord8X64OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord8X64OffAddr :: PrimMonad m => Addr -> Int -> Word8X64 -> m ()
writeWord8X64OffAddr (Addr a) (I# i) (Word8X64 m1 m2) = primitive_ (writeWord8X32OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1) >> primitive_ (writeWord8X32OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0# m2)
