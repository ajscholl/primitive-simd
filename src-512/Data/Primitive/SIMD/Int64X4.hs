...
-- ** Int64X4
data Int64X4 = Int64X4 Int64X4# deriving Typeable
...
packInt64X4 (I64# x1, I64# x2, I64# x3, I64# x4) = Int64X4 (packInt64X4# (# x1, x2, x3, x4 #))

{-# INLINE unpackInt64X4 #-}
-- | Unpack the elements of a vector into a tuple.
unpackInt64X4 :: Int64X4 -> (Int64, Int64, Int64, Int64)
unpackInt64X4 (Int64X4 m1) = case unpackInt64X4# m1 of
    (# x1, x2, x3, x4 #) -> (I64# x1, I64# x2, I64# x3, I64# x4)

{-# INLINE unsafeInsertInt64X4 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertInt64X4 :: Int64X4 -> Int64 -> Int -> Int64X4
unsafeInsertInt64X4 (Int64X4 m1) (I64# y) _i@(I# ip) = Int64X4 (insertInt64X4# m1 y (ip -# 0#))
...
plusInt64X4 (Int64X4 m1_1) (Int64X4 m1_2) = Int64X4 (plusInt64X4# m1_1 m1_2)

{-# INLINE minusInt64X4 #-}
-- | Subtract two vectors element-wise.
minusInt64X4 :: Int64X4 -> Int64X4 -> Int64X4
minusInt64X4 (Int64X4 m1_1) (Int64X4 m1_2) = Int64X4 (minusInt64X4# m1_1 m1_2)

{-# INLINE timesInt64X4 #-}
-- | Multiply two vectors element-wise.
timesInt64X4 :: Int64X4 -> Int64X4 -> Int64X4
timesInt64X4 (Int64X4 m1_1) (Int64X4 m1_2) = Int64X4 (timesInt64X4# m1_1 m1_2)

{-# INLINE quotInt64X4 #-}
-- | Rounds towards zero element-wise.
quotInt64X4 :: Int64X4 -> Int64X4 -> Int64X4
quotInt64X4 (Int64X4 m1_1) (Int64X4 m1_2) = Int64X4 (quotInt64X4# m1_1 m1_2)

{-# INLINE remInt64X4 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt64X4 :: Int64X4 -> Int64X4 -> Int64X4
remInt64X4 (Int64X4 m1_1) (Int64X4 m1_2) = Int64X4 (remInt64X4# m1_1 m1_2)

{-# INLINE negateInt64X4 #-}
-- | Negate element-wise.
negateInt64X4 :: Int64X4 -> Int64X4
negateInt64X4 (Int64X4 m1_1) = Int64X4 (negateInt64X4# m1_1)

{-# INLINE indexInt64X4Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt64X4Array :: ByteArray -> Int -> Int64X4
indexInt64X4Array (ByteArray a) (I# i) = Int64X4 (indexInt64X4Array# a i)

{-# INLINE readInt64X4Array #-}
-- | Read a vector from specified index of the mutable array.
readInt64X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int64X4
readInt64X4Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt64X4Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Int64X4 m1 #))

{-# INLINE writeInt64X4Array #-}
-- | Write a vector to specified index of mutable array.
writeInt64X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int64X4 -> m ()
writeInt64X4Array (MutableByteArray a) (I# i) (Int64X4 m1) = primitive_ (writeInt64X4Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexInt64X4OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt64X4OffAddr :: Addr -> Int -> Int64X4
indexInt64X4OffAddr (Addr a) (I# i) = Int64X4 (indexInt64X4OffAddr# (plusAddr# a (i *# 32#)) 0#)

{-# INLINE readInt64X4OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt64X4OffAddr :: PrimMonad m => Addr -> Int -> m Int64X4
readInt64X4OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt64X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 32#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Int64X4 m1 #))

{-# INLINE writeInt64X4OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt64X4OffAddr :: PrimMonad m => Addr -> Int -> Int64X4 -> m ()
writeInt64X4OffAddr (Addr a) (I# i) (Int64X4 m1) = primitive_ (writeInt64X4OffAddr# (plusAddr# a ((i *# 32#) +# 0#)) 0# m1)
