...
-- ** Word16X32
data Word16X32 = Word16X32 Word16X16# Word16X16# deriving Typeable
...
packWord16X32 (W16# x1, W16# x2, W16# x3, W16# x4, W16# x5, W16# x6, W16# x7, W16# x8, W16# x9, W16# x10, W16# x11, W16# x12, W16# x13, W16# x14, W16# x15, W16# x16, W16# x17, W16# x18, W16# x19, W16# x20, W16# x21, W16# x22, W16# x23, W16# x24, W16# x25, W16# x26, W16# x27, W16# x28, W16# x29, W16# x30, W16# x31, W16# x32) = Word16X32 (packWord16X16# (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #)) (packWord16X16# (# x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32 #))
...
unpackWord16X32 (Word16X32 m1 m2) = case unpackWord16X16# m1 of
    (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #) -> case unpackWord16X16# m2 of
        (# x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32 #) -> (W16# x1, W16# x2, W16# x3, W16# x4, W16# x5, W16# x6, W16# x7, W16# x8, W16# x9, W16# x10, W16# x11, W16# x12, W16# x13, W16# x14, W16# x15, W16# x16, W16# x17, W16# x18, W16# x19, W16# x20, W16# x21, W16# x22, W16# x23, W16# x24, W16# x25, W16# x26, W16# x27, W16# x28, W16# x29, W16# x30, W16# x31, W16# x32)

{-# INLINE unsafeInsertWord16X32 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord16X32 :: Word16X32 -> Word16 -> Int -> Word16X32
unsafeInsertWord16X32 (Word16X32 m1 m2) (W16# y) _i@(I# ip) | _i < 16 = Word16X32 (insertWord16X16# m1 y (ip -# 0#)) m2
                                                            | otherwise = Word16X32 m1 (insertWord16X16# m2 y (ip -# 16#))
...
sumWord16X32 (Word16X32 x1 x2) = case unpackWord16X16# (plusWord16X16# x1 x2) of
    (# y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16 #) -> W16# y1 + W16# y2 + W16# y3 + W16# y4 + W16# y5 + W16# y6 + W16# y7 + W16# y8 + W16# y9 + W16# y10 + W16# y11 + W16# y12 + W16# y13 + W16# y14 + W16# y15 + W16# y16

{-# INLINE plusWord16X32 #-}
-- | Add two vectors element-wise.
plusWord16X32 :: Word16X32 -> Word16X32 -> Word16X32
plusWord16X32 (Word16X32 m1_1 m2_1) (Word16X32 m1_2 m2_2) = Word16X32 (plusWord16X16# m1_1 m1_2) (plusWord16X16# m2_1 m2_2)

{-# INLINE minusWord16X32 #-}
-- | Subtract two vectors element-wise.
minusWord16X32 :: Word16X32 -> Word16X32 -> Word16X32
minusWord16X32 (Word16X32 m1_1 m2_1) (Word16X32 m1_2 m2_2) = Word16X32 (minusWord16X16# m1_1 m1_2) (minusWord16X16# m2_1 m2_2)

{-# INLINE timesWord16X32 #-}
-- | Multiply two vectors element-wise.
timesWord16X32 :: Word16X32 -> Word16X32 -> Word16X32
timesWord16X32 (Word16X32 m1_1 m2_1) (Word16X32 m1_2 m2_2) = Word16X32 (timesWord16X16# m1_1 m1_2) (timesWord16X16# m2_1 m2_2)

{-# INLINE quotWord16X32 #-}
-- | Rounds towards zero element-wise.
quotWord16X32 :: Word16X32 -> Word16X32 -> Word16X32
quotWord16X32 (Word16X32 m1_1 m2_1) (Word16X32 m1_2 m2_2) = Word16X32 (quotWord16X16# m1_1 m1_2) (quotWord16X16# m2_1 m2_2)

{-# INLINE remWord16X32 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord16X32 :: Word16X32 -> Word16X32 -> Word16X32
remWord16X32 (Word16X32 m1_1 m2_1) (Word16X32 m1_2 m2_2) = Word16X32 (remWord16X16# m1_1 m1_2) (remWord16X16# m2_1 m2_2)

{-# INLINE indexWord16X32Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord16X32Array :: ByteArray -> Int -> Word16X32
indexWord16X32Array (ByteArray a) (I# i) = Word16X32 (indexWord16X16Array# a ((i *# 2#) +# 0#)) (indexWord16X16Array# a ((i *# 2#) +# 1#))

{-# INLINE readWord16X32Array #-}
-- | Read a vector from specified index of the mutable array.
readWord16X32Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word16X32
readWord16X32Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord16X16Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readWord16X16Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Word16X32 m1 m2 #))

{-# INLINE writeWord16X32Array #-}
-- | Write a vector to specified index of mutable array.
writeWord16X32Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word16X32 -> m ()
writeWord16X32Array (MutableByteArray a) (I# i) (Word16X32 m1 m2) = primitive_ (writeWord16X16Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeWord16X16Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexWord16X32OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord16X32OffAddr :: Addr -> Int -> Word16X32
indexWord16X32OffAddr (Addr a) (I# i) = Word16X32 (indexWord16X16OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0#) (indexWord16X16OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0#)

{-# INLINE readWord16X32OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord16X32OffAddr :: PrimMonad m => Addr -> Int -> m Word16X32
readWord16X32OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord16X16OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readWord16X16OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 32#) s1 of
        (# s2, m2 #) -> (# s2, Word16X32 m1 m2 #))

{-# INLINE writeWord16X32OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord16X32OffAddr :: PrimMonad m => Addr -> Int -> Word16X32 -> m ()
writeWord16X32OffAddr (Addr a) (I# i) (Word16X32 m1 m2) = primitive_ (writeWord16X16OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1) >> primitive_ (writeWord16X16OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0# m2)
