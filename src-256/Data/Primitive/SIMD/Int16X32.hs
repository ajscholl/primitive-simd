...
-- ** Int16X32
data Int16X32 = Int16X32 Int16X16# Int16X16# deriving Typeable
...
packInt16X32 (I16# x1, I16# x2, I16# x3, I16# x4, I16# x5, I16# x6, I16# x7, I16# x8, I16# x9, I16# x10, I16# x11, I16# x12, I16# x13, I16# x14, I16# x15, I16# x16, I16# x17, I16# x18, I16# x19, I16# x20, I16# x21, I16# x22, I16# x23, I16# x24, I16# x25, I16# x26, I16# x27, I16# x28, I16# x29, I16# x30, I16# x31, I16# x32) = Int16X32 (packInt16X16# (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #)) (packInt16X16# (# x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32 #))
...
unpackInt16X32 (Int16X32 m1 m2) = case unpackInt16X16# m1 of
    (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #) -> case unpackInt16X16# m2 of
        (# x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30, x31, x32 #) -> (I16# x1, I16# x2, I16# x3, I16# x4, I16# x5, I16# x6, I16# x7, I16# x8, I16# x9, I16# x10, I16# x11, I16# x12, I16# x13, I16# x14, I16# x15, I16# x16, I16# x17, I16# x18, I16# x19, I16# x20, I16# x21, I16# x22, I16# x23, I16# x24, I16# x25, I16# x26, I16# x27, I16# x28, I16# x29, I16# x30, I16# x31, I16# x32)

{-# INLINE unsafeInsertInt16X32 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertInt16X32 :: Int16X32 -> Int16 -> Int -> Int16X32
unsafeInsertInt16X32 (Int16X32 m1 m2) (I16# y) _i@(I# ip) | _i < 16 = Int16X32 (insertInt16X16# m1 y (ip -# 0#)) m2
                                                          | otherwise = Int16X32 m1 (insertInt16X16# m2 y (ip -# 16#))
...
{-# RULES "foldVector (+)" foldInt16X32 (+) = sumVector #-}

{-# INLINE sumInt16X32 #-}
-- | Sum up the elements of a vector to a single value.
sumInt16X32 :: Int16X32 -> Int16
sumInt16X32 (Int16X32 x1 x2) = case unpackInt16X16# (plusInt16X16# x1 x2) of
    (# y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16 #) -> I16# y1 + I16# y2 + I16# y3 + I16# y4 + I16# y5 + I16# y6 + I16# y7 + I16# y8 + I16# y9 + I16# y10 + I16# y11 + I16# y12 + I16# y13 + I16# y14 + I16# y15 + I16# y16

{-# INLINE plusInt16X32 #-}
-- | Add two vectors element-wise.
plusInt16X32 :: Int16X32 -> Int16X32 -> Int16X32
plusInt16X32 (Int16X32 m1_1 m2_1) (Int16X32 m1_2 m2_2) = Int16X32 (plusInt16X16# m1_1 m1_2) (plusInt16X16# m2_1 m2_2)

{-# INLINE minusInt16X32 #-}
-- | Subtract two vectors element-wise.
minusInt16X32 :: Int16X32 -> Int16X32 -> Int16X32
minusInt16X32 (Int16X32 m1_1 m2_1) (Int16X32 m1_2 m2_2) = Int16X32 (minusInt16X16# m1_1 m1_2) (minusInt16X16# m2_1 m2_2)

{-# INLINE timesInt16X32 #-}
-- | Multiply two vectors element-wise.
timesInt16X32 :: Int16X32 -> Int16X32 -> Int16X32
timesInt16X32 (Int16X32 m1_1 m2_1) (Int16X32 m1_2 m2_2) = Int16X32 (timesInt16X16# m1_1 m1_2) (timesInt16X16# m2_1 m2_2)

{-# INLINE quotInt16X32 #-}
-- | Rounds towards zero element-wise.
quotInt16X32 :: Int16X32 -> Int16X32 -> Int16X32
quotInt16X32 (Int16X32 m1_1 m2_1) (Int16X32 m1_2 m2_2) = Int16X32 (quotInt16X16# m1_1 m1_2) (quotInt16X16# m2_1 m2_2)

{-# INLINE remInt16X32 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt16X32 :: Int16X32 -> Int16X32 -> Int16X32
remInt16X32 (Int16X32 m1_1 m2_1) (Int16X32 m1_2 m2_2) = Int16X32 (remInt16X16# m1_1 m1_2) (remInt16X16# m2_1 m2_2)

{-# INLINE negateInt16X32 #-}
-- | Negate element-wise.
negateInt16X32 :: Int16X32 -> Int16X32
negateInt16X32 (Int16X32 m1_1 m2_1) = Int16X32 (negateInt16X16# m1_1) (negateInt16X16# m2_1)

{-# INLINE indexInt16X32Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt16X32Array :: ByteArray -> Int -> Int16X32
indexInt16X32Array (ByteArray a) (I# i) = Int16X32 (indexInt16X16Array# a ((i *# 2#) +# 0#)) (indexInt16X16Array# a ((i *# 2#) +# 1#))

{-# INLINE readInt16X32Array #-}
-- | Read a vector from specified index of the mutable array.
readInt16X32Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int16X32
readInt16X32Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt16X16Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readInt16X16Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Int16X32 m1 m2 #))

{-# INLINE writeInt16X32Array #-}
-- | Write a vector to specified index of mutable array.
writeInt16X32Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int16X32 -> m ()
writeInt16X32Array (MutableByteArray a) (I# i) (Int16X32 m1 m2) = primitive_ (writeInt16X16Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeInt16X16Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexInt16X32OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt16X32OffAddr :: Addr -> Int -> Int16X32
indexInt16X32OffAddr (Addr a) (I# i) = Int16X32 (indexInt16X16OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0#) (indexInt16X16OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0#)

{-# INLINE readInt16X32OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt16X32OffAddr :: PrimMonad m => Addr -> Int -> m Int16X32
readInt16X32OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt16X16OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readInt16X16OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 32#) s1 of
        (# s2, m2 #) -> (# s2, Int16X32 m1 m2 #))

{-# INLINE writeInt16X32OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt16X32OffAddr :: PrimMonad m => Addr -> Int -> Int16X32 -> m ()
writeInt16X32OffAddr (Addr a) (I# i) (Int16X32 m1 m2) = primitive_ (writeInt16X16OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1) >> primitive_ (writeInt16X16OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0# m2)
