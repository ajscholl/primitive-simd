...
-- ** Int64X8
data Int64X8 = Int64X8 Int64X4# Int64X4# deriving Typeable
...
packInt64X8 (I64# x1, I64# x2, I64# x3, I64# x4, I64# x5, I64# x6, I64# x7, I64# x8) = Int64X8 (packInt64X4# (# x1, x2, x3, x4 #)) (packInt64X4# (# x5, x6, x7, x8 #))

{-# INLINE unpackInt64X8 #-}
-- | Unpack the elements of a vector into a tuple.
unpackInt64X8 :: Int64X8 -> (Int64, Int64, Int64, Int64, Int64, Int64, Int64, Int64)
unpackInt64X8 (Int64X8 m1 m2) = case unpackInt64X4# m1 of
    (# x1, x2, x3, x4 #) -> case unpackInt64X4# m2 of
        (# x5, x6, x7, x8 #) -> (I64# x1, I64# x2, I64# x3, I64# x4, I64# x5, I64# x6, I64# x7, I64# x8)

{-# INLINE unsafeInsertInt64X8 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertInt64X8 :: Int64X8 -> Int64 -> Int -> Int64X8
unsafeInsertInt64X8 (Int64X8 m1 m2) (I64# y) _i@(I# ip) | _i < 4 = Int64X8 (insertInt64X4# m1 y (ip -# 0#)) m2
                                                        | otherwise = Int64X8 m1 (insertInt64X4# m2 y (ip -# 4#))
...
{-# RULES "foldVector (+)" foldInt64X8 (+) = sumVector #-}

{-# INLINE sumInt64X8 #-}
-- | Sum up the elements of a vector to a single value.
sumInt64X8 :: Int64X8 -> Int64
sumInt64X8 (Int64X8 x1 x2) = case unpackInt64X4# (plusInt64X4# x1 x2) of
    (# y1, y2, y3, y4 #) -> I64# y1 + I64# y2 + I64# y3 + I64# y4

{-# INLINE plusInt64X8 #-}
-- | Add two vectors element-wise.
plusInt64X8 :: Int64X8 -> Int64X8 -> Int64X8
plusInt64X8 (Int64X8 m1_1 m2_1) (Int64X8 m1_2 m2_2) = Int64X8 (plusInt64X4# m1_1 m1_2) (plusInt64X4# m2_1 m2_2)

{-# INLINE minusInt64X8 #-}
-- | Subtract two vectors element-wise.
minusInt64X8 :: Int64X8 -> Int64X8 -> Int64X8
minusInt64X8 (Int64X8 m1_1 m2_1) (Int64X8 m1_2 m2_2) = Int64X8 (minusInt64X4# m1_1 m1_2) (minusInt64X4# m2_1 m2_2)

{-# INLINE timesInt64X8 #-}
-- | Multiply two vectors element-wise.
timesInt64X8 :: Int64X8 -> Int64X8 -> Int64X8
timesInt64X8 (Int64X8 m1_1 m2_1) (Int64X8 m1_2 m2_2) = Int64X8 (timesInt64X4# m1_1 m1_2) (timesInt64X4# m2_1 m2_2)

{-# INLINE quotInt64X8 #-}
-- | Rounds towards zero element-wise.
quotInt64X8 :: Int64X8 -> Int64X8 -> Int64X8
quotInt64X8 (Int64X8 m1_1 m2_1) (Int64X8 m1_2 m2_2) = Int64X8 (quotInt64X4# m1_1 m1_2) (quotInt64X4# m2_1 m2_2)

{-# INLINE remInt64X8 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt64X8 :: Int64X8 -> Int64X8 -> Int64X8
remInt64X8 (Int64X8 m1_1 m2_1) (Int64X8 m1_2 m2_2) = Int64X8 (remInt64X4# m1_1 m1_2) (remInt64X4# m2_1 m2_2)

{-# INLINE negateInt64X8 #-}
-- | Negate element-wise.
negateInt64X8 :: Int64X8 -> Int64X8
negateInt64X8 (Int64X8 m1_1 m2_1) = Int64X8 (negateInt64X4# m1_1) (negateInt64X4# m2_1)

{-# INLINE indexInt64X8Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt64X8Array :: ByteArray -> Int -> Int64X8
indexInt64X8Array (ByteArray a) (I# i) = Int64X8 (indexInt64X4Array# a ((i *# 2#) +# 0#)) (indexInt64X4Array# a ((i *# 2#) +# 1#))

{-# INLINE readInt64X8Array #-}
-- | Read a vector from specified index of the mutable array.
readInt64X8Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int64X8
readInt64X8Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt64X4Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readInt64X4Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Int64X8 m1 m2 #))

{-# INLINE writeInt64X8Array #-}
-- | Write a vector to specified index of mutable array.
writeInt64X8Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int64X8 -> m ()
writeInt64X8Array (MutableByteArray a) (I# i) (Int64X8 m1 m2) = primitive_ (writeInt64X4Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeInt64X4Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexInt64X8OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt64X8OffAddr :: Addr -> Int -> Int64X8
indexInt64X8OffAddr (Addr a) (I# i) = Int64X8 (indexInt64X4OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0#) (indexInt64X4OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0#)

{-# INLINE readInt64X8OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt64X8OffAddr :: PrimMonad m => Addr -> Int -> m Int64X8
readInt64X8OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt64X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readInt64X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 32#) s1 of
        (# s2, m2 #) -> (# s2, Int64X8 m1 m2 #))

{-# INLINE writeInt64X8OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt64X8OffAddr :: PrimMonad m => Addr -> Int -> Int64X8 -> m ()
writeInt64X8OffAddr (Addr a) (I# i) (Int64X8 m1 m2) = primitive_ (writeInt64X4OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1) >> primitive_ (writeInt64X4OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0# m2)
