...
-- ** Word16X16
data Word16X16 = Word16X16 Word16X16# deriving Typeable
...
packWord16X16 (W16# x1, W16# x2, W16# x3, W16# x4, W16# x5, W16# x6, W16# x7, W16# x8, W16# x9, W16# x10, W16# x11, W16# x12, W16# x13, W16# x14, W16# x15, W16# x16) = Word16X16 (packWord16X16# (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #))
...
unpackWord16X16 (Word16X16 m1) = case unpackWord16X16# m1 of
    (# x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16 #) -> (W16# x1, W16# x2, W16# x3, W16# x4, W16# x5, W16# x6, W16# x7, W16# x8, W16# x9, W16# x10, W16# x11, W16# x12, W16# x13, W16# x14, W16# x15, W16# x16)

{-# INLINE unsafeInsertWord16X16 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord16X16 :: Word16X16 -> Word16 -> Int -> Word16X16
unsafeInsertWord16X16 (Word16X16 m1) (W16# y) _i@(I# ip) = Word16X16 (insertWord16X16# m1 y (ip -# 0#))
...
plusWord16X16 (Word16X16 m1_1) (Word16X16 m1_2) = Word16X16 (plusWord16X16# m1_1 m1_2)

{-# INLINE minusWord16X16 #-}
-- | Subtract two vectors element-wise.
minusWord16X16 :: Word16X16 -> Word16X16 -> Word16X16
minusWord16X16 (Word16X16 m1_1) (Word16X16 m1_2) = Word16X16 (minusWord16X16# m1_1 m1_2)

{-# INLINE timesWord16X16 #-}
-- | Multiply two vectors element-wise.
timesWord16X16 :: Word16X16 -> Word16X16 -> Word16X16
timesWord16X16 (Word16X16 m1_1) (Word16X16 m1_2) = Word16X16 (timesWord16X16# m1_1 m1_2)

{-# INLINE quotWord16X16 #-}
-- | Rounds towards zero element-wise.
quotWord16X16 :: Word16X16 -> Word16X16 -> Word16X16
quotWord16X16 (Word16X16 m1_1) (Word16X16 m1_2) = Word16X16 (quotWord16X16# m1_1 m1_2)

{-# INLINE remWord16X16 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord16X16 :: Word16X16 -> Word16X16 -> Word16X16
remWord16X16 (Word16X16 m1_1) (Word16X16 m1_2) = Word16X16 (remWord16X16# m1_1 m1_2)

{-# INLINE indexWord16X16Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord16X16Array :: ByteArray -> Int -> Word16X16
indexWord16X16Array (ByteArray a) (I# i) = Word16X16 (indexWord16X16Array# a i)

{-# INLINE readWord16X16Array #-}
-- | Read a vector from specified index of the mutable array.
readWord16X16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word16X16
readWord16X16Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord16X16Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word16X16 m1 #))

{-# INLINE writeWord16X16Array #-}
-- | Write a vector to specified index of mutable array.
writeWord16X16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word16X16 -> m ()
writeWord16X16Array (MutableByteArray a) (I# i) (Word16X16 m1) = primitive_ (writeWord16X16Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexWord16X16OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord16X16OffAddr :: Addr -> Int -> Word16X16
indexWord16X16OffAddr (Addr a) (I# i) = Word16X16 (indexWord16X16OffAddr# (plusAddr# a (i *# 32#)) 0#)

{-# INLINE readWord16X16OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord16X16OffAddr :: PrimMonad m => Addr -> Int -> m Word16X16
readWord16X16OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord16X16OffAddr# (plusAddr# addr i') 0#) a ((i *# 32#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word16X16 m1 #))

{-# INLINE writeWord16X16OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord16X16OffAddr :: PrimMonad m => Addr -> Int -> Word16X16 -> m ()
writeWord16X16OffAddr (Addr a) (I# i) (Word16X16 m1) = primitive_ (writeWord16X16OffAddr# (plusAddr# a ((i *# 32#) +# 0#)) 0# m1)
