...
-- ** Word32X16
data Word32X16 = Word32X16 Word32X8# Word32X8# deriving Typeable
...
packWord32X16 (W32# x1, W32# x2, W32# x3, W32# x4, W32# x5, W32# x6, W32# x7, W32# x8, W32# x9, W32# x10, W32# x11, W32# x12, W32# x13, W32# x14, W32# x15, W32# x16) = Word32X16 (packWord32X8# (# x1, x2, x3, x4, x5, x6, x7, x8 #)) (packWord32X8# (# x9, x10, x11, x12, x13, x14, x15, x16 #))
...
unpackWord32X16 (Word32X16 m1 m2) = case unpackWord32X8# m1 of
    (# x1, x2, x3, x4, x5, x6, x7, x8 #) -> case unpackWord32X8# m2 of
        (# x9, x10, x11, x12, x13, x14, x15, x16 #) -> (W32# x1, W32# x2, W32# x3, W32# x4, W32# x5, W32# x6, W32# x7, W32# x8, W32# x9, W32# x10, W32# x11, W32# x12, W32# x13, W32# x14, W32# x15, W32# x16)

{-# INLINE unsafeInsertWord32X16 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord32X16 :: Word32X16 -> Word32 -> Int -> Word32X16
unsafeInsertWord32X16 (Word32X16 m1 m2) (W32# y) _i@(I# ip) | _i < 8 = Word32X16 (insertWord32X8# m1 y (ip -# 0#)) m2
                                                            | otherwise = Word32X16 m1 (insertWord32X8# m2 y (ip -# 8#))
...
sumWord32X16 (Word32X16 x1 x2) = case unpackWord32X8# (plusWord32X8# x1 x2) of
    (# y1, y2, y3, y4, y5, y6, y7, y8 #) -> W32# y1 + W32# y2 + W32# y3 + W32# y4 + W32# y5 + W32# y6 + W32# y7 + W32# y8

{-# INLINE plusWord32X16 #-}
-- | Add two vectors element-wise.
plusWord32X16 :: Word32X16 -> Word32X16 -> Word32X16
plusWord32X16 (Word32X16 m1_1 m2_1) (Word32X16 m1_2 m2_2) = Word32X16 (plusWord32X8# m1_1 m1_2) (plusWord32X8# m2_1 m2_2)

{-# INLINE minusWord32X16 #-}
-- | Subtract two vectors element-wise.
minusWord32X16 :: Word32X16 -> Word32X16 -> Word32X16
minusWord32X16 (Word32X16 m1_1 m2_1) (Word32X16 m1_2 m2_2) = Word32X16 (minusWord32X8# m1_1 m1_2) (minusWord32X8# m2_1 m2_2)

{-# INLINE timesWord32X16 #-}
-- | Multiply two vectors element-wise.
timesWord32X16 :: Word32X16 -> Word32X16 -> Word32X16
timesWord32X16 (Word32X16 m1_1 m2_1) (Word32X16 m1_2 m2_2) = Word32X16 (timesWord32X8# m1_1 m1_2) (timesWord32X8# m2_1 m2_2)

{-# INLINE quotWord32X16 #-}
-- | Rounds towards zero element-wise.
quotWord32X16 :: Word32X16 -> Word32X16 -> Word32X16
quotWord32X16 (Word32X16 m1_1 m2_1) (Word32X16 m1_2 m2_2) = Word32X16 (quotWord32X8# m1_1 m1_2) (quotWord32X8# m2_1 m2_2)

{-# INLINE remWord32X16 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord32X16 :: Word32X16 -> Word32X16 -> Word32X16
remWord32X16 (Word32X16 m1_1 m2_1) (Word32X16 m1_2 m2_2) = Word32X16 (remWord32X8# m1_1 m1_2) (remWord32X8# m2_1 m2_2)

{-# INLINE indexWord32X16Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord32X16Array :: ByteArray -> Int -> Word32X16
indexWord32X16Array (ByteArray a) (I# i) = Word32X16 (indexWord32X8Array# a ((i *# 2#) +# 0#)) (indexWord32X8Array# a ((i *# 2#) +# 1#))

{-# INLINE readWord32X16Array #-}
-- | Read a vector from specified index of the mutable array.
readWord32X16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word32X16
readWord32X16Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord32X8Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readWord32X8Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Word32X16 m1 m2 #))

{-# INLINE writeWord32X16Array #-}
-- | Write a vector to specified index of mutable array.
writeWord32X16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word32X16 -> m ()
writeWord32X16Array (MutableByteArray a) (I# i) (Word32X16 m1 m2) = primitive_ (writeWord32X8Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeWord32X8Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexWord32X16OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord32X16OffAddr :: Addr -> Int -> Word32X16
indexWord32X16OffAddr (Addr a) (I# i) = Word32X16 (indexWord32X8OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0#) (indexWord32X8OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0#)

{-# INLINE readWord32X16OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord32X16OffAddr :: PrimMonad m => Addr -> Int -> m Word32X16
readWord32X16OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord32X8OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readWord32X8OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 32#) s1 of
        (# s2, m2 #) -> (# s2, Word32X16 m1 m2 #))

{-# INLINE writeWord32X16OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord32X16OffAddr :: PrimMonad m => Addr -> Int -> Word32X16 -> m ()
writeWord32X16OffAddr (Addr a) (I# i) (Word32X16 m1 m2) = primitive_ (writeWord32X8OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1) >> primitive_ (writeWord32X8OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0# m2)
