...
-- ** FloatX16
data FloatX16 = FloatX16 FloatX8# FloatX8# deriving Typeable
...
packFloatX16 (F# x1, F# x2, F# x3, F# x4, F# x5, F# x6, F# x7, F# x8, F# x9, F# x10, F# x11, F# x12, F# x13, F# x14, F# x15, F# x16) = FloatX16 (packFloatX8# (# x1, x2, x3, x4, x5, x6, x7, x8 #)) (packFloatX8# (# x9, x10, x11, x12, x13, x14, x15, x16 #))

{-# INLINE unpackFloatX16 #-}
-- | Unpack the elements of a vector into a tuple.
unpackFloatX16 :: FloatX16 -> (Float, Float, Float, Float, Float, Float, Float, Float, Float, Float, Float, Float, Float, Float, Float, Float)
unpackFloatX16 (FloatX16 m1 m2) = case unpackFloatX8# m1 of
    (# x1, x2, x3, x4, x5, x6, x7, x8 #) -> case unpackFloatX8# m2 of
        (# x9, x10, x11, x12, x13, x14, x15, x16 #) -> (F# x1, F# x2, F# x3, F# x4, F# x5, F# x6, F# x7, F# x8, F# x9, F# x10, F# x11, F# x12, F# x13, F# x14, F# x15, F# x16)

{-# INLINE unsafeInsertFloatX16 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertFloatX16 :: FloatX16 -> Float -> Int -> FloatX16
unsafeInsertFloatX16 (FloatX16 m1 m2) (F# y) _i@(I# ip) | _i < 8 = FloatX16 (insertFloatX8# m1 y (ip -# 0#)) m2
                                                        | otherwise = FloatX16 m1 (insertFloatX8# m2 y (ip -# 8#))
...
sumFloatX16 (FloatX16 x1 x2) = case unpackFloatX8# (plusFloatX8# x1 x2) of
    (# y1, y2, y3, y4, y5, y6, y7, y8 #) -> F# y1 + F# y2 + F# y3 + F# y4 + F# y5 + F# y6 + F# y7 + F# y8

{-# INLINE plusFloatX16 #-}
-- | Add two vectors element-wise.
plusFloatX16 :: FloatX16 -> FloatX16 -> FloatX16
plusFloatX16 (FloatX16 m1_1 m2_1) (FloatX16 m1_2 m2_2) = FloatX16 (plusFloatX8# m1_1 m1_2) (plusFloatX8# m2_1 m2_2)

{-# INLINE minusFloatX16 #-}
-- | Subtract two vectors element-wise.
minusFloatX16 :: FloatX16 -> FloatX16 -> FloatX16
minusFloatX16 (FloatX16 m1_1 m2_1) (FloatX16 m1_2 m2_2) = FloatX16 (minusFloatX8# m1_1 m1_2) (minusFloatX8# m2_1 m2_2)

{-# INLINE timesFloatX16 #-}
-- | Multiply two vectors element-wise.
timesFloatX16 :: FloatX16 -> FloatX16 -> FloatX16
timesFloatX16 (FloatX16 m1_1 m2_1) (FloatX16 m1_2 m2_2) = FloatX16 (timesFloatX8# m1_1 m1_2) (timesFloatX8# m2_1 m2_2)

{-# INLINE divideFloatX16 #-}
-- | Divide two vectors element-wise.
divideFloatX16 :: FloatX16 -> FloatX16 -> FloatX16
divideFloatX16 (FloatX16 m1_1 m2_1) (FloatX16 m1_2 m2_2) = FloatX16 (divideFloatX8# m1_1 m1_2) (divideFloatX8# m2_1 m2_2)

{-# INLINE negateFloatX16 #-}
-- | Negate element-wise.
negateFloatX16 :: FloatX16 -> FloatX16
negateFloatX16 (FloatX16 m1_1 m2_1) = FloatX16 (negateFloatX8# m1_1) (negateFloatX8# m2_1)

{-# INLINE indexFloatX16Array #-}
-- | Read a vector from specified index of the immutable array.
indexFloatX16Array :: ByteArray -> Int -> FloatX16
indexFloatX16Array (ByteArray a) (I# i) = FloatX16 (indexFloatX8Array# a ((i *# 2#) +# 0#)) (indexFloatX8Array# a ((i *# 2#) +# 1#))

{-# INLINE readFloatX16Array #-}
-- | Read a vector from specified index of the mutable array.
readFloatX16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m FloatX16
readFloatX16Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readFloatX8Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readFloatX8Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, FloatX16 m1 m2 #))

{-# INLINE writeFloatX16Array #-}
-- | Write a vector to specified index of mutable array.
writeFloatX16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> FloatX16 -> m ()
writeFloatX16Array (MutableByteArray a) (I# i) (FloatX16 m1 m2) = primitive_ (writeFloatX8Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeFloatX8Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexFloatX16OffAddr #-}
-- | Reads vector from the specified index of the address.
indexFloatX16OffAddr :: Addr -> Int -> FloatX16
indexFloatX16OffAddr (Addr a) (I# i) = FloatX16 (indexFloatX8OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0#) (indexFloatX8OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0#)

{-# INLINE readFloatX16OffAddr #-}
-- | Reads vector from the specified index of the address.
readFloatX16OffAddr :: PrimMonad m => Addr -> Int -> m FloatX16
readFloatX16OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readFloatX8OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readFloatX8OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 32#) s1 of
        (# s2, m2 #) -> (# s2, FloatX16 m1 m2 #))

{-# INLINE writeFloatX16OffAddr #-}
-- | Write vector to the specified index of the address.
writeFloatX16OffAddr :: PrimMonad m => Addr -> Int -> FloatX16 -> m ()
writeFloatX16OffAddr (Addr a) (I# i) (FloatX16 m1 m2) = primitive_ (writeFloatX8OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1) >> primitive_ (writeFloatX8OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0# m2)
