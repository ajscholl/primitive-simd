...
-- ** Word64X4
data Word64X4 = Word64X4 Word64X4# deriving Typeable
...
packWord64X4 (W64# x1, W64# x2, W64# x3, W64# x4) = Word64X4 (packWord64X4# (# x1, x2, x3, x4 #))

{-# INLINE unpackWord64X4 #-}
-- | Unpack the elements of a vector into a tuple.
unpackWord64X4 :: Word64X4 -> (Word64, Word64, Word64, Word64)
unpackWord64X4 (Word64X4 m1) = case unpackWord64X4# m1 of
    (# x1, x2, x3, x4 #) -> (W64# x1, W64# x2, W64# x3, W64# x4)

{-# INLINE unsafeInsertWord64X4 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord64X4 :: Word64X4 -> Word64 -> Int -> Word64X4
unsafeInsertWord64X4 (Word64X4 m1) (W64# y) _i@(I# ip) = Word64X4 (insertWord64X4# m1 y (ip -# 0#))
...
plusWord64X4 (Word64X4 m1_1) (Word64X4 m1_2) = Word64X4 (plusWord64X4# m1_1 m1_2)

{-# INLINE minusWord64X4 #-}
-- | Subtract two vectors element-wise.
minusWord64X4 :: Word64X4 -> Word64X4 -> Word64X4
minusWord64X4 (Word64X4 m1_1) (Word64X4 m1_2) = Word64X4 (minusWord64X4# m1_1 m1_2)

{-# INLINE timesWord64X4 #-}
-- | Multiply two vectors element-wise.
timesWord64X4 :: Word64X4 -> Word64X4 -> Word64X4
timesWord64X4 (Word64X4 m1_1) (Word64X4 m1_2) = Word64X4 (timesWord64X4# m1_1 m1_2)

{-# INLINE quotWord64X4 #-}
-- | Rounds towards zero element-wise.
quotWord64X4 :: Word64X4 -> Word64X4 -> Word64X4
quotWord64X4 (Word64X4 m1_1) (Word64X4 m1_2) = Word64X4 (quotWord64X4# m1_1 m1_2)

{-# INLINE remWord64X4 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord64X4 :: Word64X4 -> Word64X4 -> Word64X4
remWord64X4 (Word64X4 m1_1) (Word64X4 m1_2) = Word64X4 (remWord64X4# m1_1 m1_2)

{-# INLINE indexWord64X4Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord64X4Array :: ByteArray -> Int -> Word64X4
indexWord64X4Array (ByteArray a) (I# i) = Word64X4 (indexWord64X4Array# a i)

{-# INLINE readWord64X4Array #-}
-- | Read a vector from specified index of the mutable array.
readWord64X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word64X4
readWord64X4Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord64X4Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word64X4 m1 #))

{-# INLINE writeWord64X4Array #-}
-- | Write a vector to specified index of mutable array.
writeWord64X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word64X4 -> m ()
writeWord64X4Array (MutableByteArray a) (I# i) (Word64X4 m1) = primitive_ (writeWord64X4Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexWord64X4OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord64X4OffAddr :: Addr -> Int -> Word64X4
indexWord64X4OffAddr (Addr a) (I# i) = Word64X4 (indexWord64X4OffAddr# (plusAddr# a (i *# 32#)) 0#)

{-# INLINE readWord64X4OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord64X4OffAddr :: PrimMonad m => Addr -> Int -> m Word64X4
readWord64X4OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord64X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 32#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word64X4 m1 #))

{-# INLINE writeWord64X4OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord64X4OffAddr :: PrimMonad m => Addr -> Int -> Word64X4 -> m ()
writeWord64X4OffAddr (Addr a) (I# i) (Word64X4 m1) = primitive_ (writeWord64X4OffAddr# (plusAddr# a ((i *# 32#) +# 0#)) 0# m1)
