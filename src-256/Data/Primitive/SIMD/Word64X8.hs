...
-- ** Word64X8
data Word64X8 = Word64X8 Word64X4# Word64X4# deriving Typeable
...
packWord64X8 (W64# x1, W64# x2, W64# x3, W64# x4, W64# x5, W64# x6, W64# x7, W64# x8) = Word64X8 (packWord64X4# (# x1, x2, x3, x4 #)) (packWord64X4# (# x5, x6, x7, x8 #))

{-# INLINE unpackWord64X8 #-}
-- | Unpack the elements of a vector into a tuple.
unpackWord64X8 :: Word64X8 -> (Word64, Word64, Word64, Word64, Word64, Word64, Word64, Word64)
unpackWord64X8 (Word64X8 m1 m2) = case unpackWord64X4# m1 of
    (# x1, x2, x3, x4 #) -> case unpackWord64X4# m2 of
        (# x5, x6, x7, x8 #) -> (W64# x1, W64# x2, W64# x3, W64# x4, W64# x5, W64# x6, W64# x7, W64# x8)

{-# INLINE unsafeInsertWord64X8 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord64X8 :: Word64X8 -> Word64 -> Int -> Word64X8
unsafeInsertWord64X8 (Word64X8 m1 m2) (W64# y) _i@(I# ip) | _i < 4 = Word64X8 (insertWord64X4# m1 y (ip -# 0#)) m2
                                                          | otherwise = Word64X8 m1 (insertWord64X4# m2 y (ip -# 4#))
...
sumWord64X8 (Word64X8 x1 x2) = case unpackWord64X4# (plusWord64X4# x1 x2) of
    (# y1, y2, y3, y4 #) -> W64# y1 + W64# y2 + W64# y3 + W64# y4

{-# INLINE plusWord64X8 #-}
-- | Add two vectors element-wise.
plusWord64X8 :: Word64X8 -> Word64X8 -> Word64X8
plusWord64X8 (Word64X8 m1_1 m2_1) (Word64X8 m1_2 m2_2) = Word64X8 (plusWord64X4# m1_1 m1_2) (plusWord64X4# m2_1 m2_2)

{-# INLINE minusWord64X8 #-}
-- | Subtract two vectors element-wise.
minusWord64X8 :: Word64X8 -> Word64X8 -> Word64X8
minusWord64X8 (Word64X8 m1_1 m2_1) (Word64X8 m1_2 m2_2) = Word64X8 (minusWord64X4# m1_1 m1_2) (minusWord64X4# m2_1 m2_2)

{-# INLINE timesWord64X8 #-}
-- | Multiply two vectors element-wise.
timesWord64X8 :: Word64X8 -> Word64X8 -> Word64X8
timesWord64X8 (Word64X8 m1_1 m2_1) (Word64X8 m1_2 m2_2) = Word64X8 (timesWord64X4# m1_1 m1_2) (timesWord64X4# m2_1 m2_2)

{-# INLINE quotWord64X8 #-}
-- | Rounds towards zero element-wise.
quotWord64X8 :: Word64X8 -> Word64X8 -> Word64X8
quotWord64X8 (Word64X8 m1_1 m2_1) (Word64X8 m1_2 m2_2) = Word64X8 (quotWord64X4# m1_1 m1_2) (quotWord64X4# m2_1 m2_2)

{-# INLINE remWord64X8 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord64X8 :: Word64X8 -> Word64X8 -> Word64X8
remWord64X8 (Word64X8 m1_1 m2_1) (Word64X8 m1_2 m2_2) = Word64X8 (remWord64X4# m1_1 m1_2) (remWord64X4# m2_1 m2_2)

{-# INLINE indexWord64X8Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord64X8Array :: ByteArray -> Int -> Word64X8
indexWord64X8Array (ByteArray a) (I# i) = Word64X8 (indexWord64X4Array# a ((i *# 2#) +# 0#)) (indexWord64X4Array# a ((i *# 2#) +# 1#))

{-# INLINE readWord64X8Array #-}
-- | Read a vector from specified index of the mutable array.
readWord64X8Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word64X8
readWord64X8Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord64X4Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readWord64X4Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Word64X8 m1 m2 #))

{-# INLINE writeWord64X8Array #-}
-- | Write a vector to specified index of mutable array.
writeWord64X8Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word64X8 -> m ()
writeWord64X8Array (MutableByteArray a) (I# i) (Word64X8 m1 m2) = primitive_ (writeWord64X4Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeWord64X4Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexWord64X8OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord64X8OffAddr :: Addr -> Int -> Word64X8
indexWord64X8OffAddr (Addr a) (I# i) = Word64X8 (indexWord64X4OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0#) (indexWord64X4OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0#)

{-# INLINE readWord64X8OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord64X8OffAddr :: PrimMonad m => Addr -> Int -> m Word64X8
readWord64X8OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord64X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readWord64X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 64#) +# 32#) s1 of
        (# s2, m2 #) -> (# s2, Word64X8 m1 m2 #))

{-# INLINE writeWord64X8OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord64X8OffAddr :: PrimMonad m => Addr -> Int -> Word64X8 -> m ()
writeWord64X8OffAddr (Addr a) (I# i) (Word64X8 m1 m2) = primitive_ (writeWord64X4OffAddr# (plusAddr# a ((i *# 64#) +# 0#)) 0# m1) >> primitive_ (writeWord64X4OffAddr# (plusAddr# a ((i *# 64#) +# 32#)) 0# m2)
