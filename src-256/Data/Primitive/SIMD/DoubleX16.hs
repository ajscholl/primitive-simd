...
-- ** DoubleX16
data DoubleX16 = DoubleX16 DoubleX4# DoubleX4# DoubleX4# DoubleX4# deriving Typeable
...
packDoubleX16 (D# x1, D# x2, D# x3, D# x4, D# x5, D# x6, D# x7, D# x8, D# x9, D# x10, D# x11, D# x12, D# x13, D# x14, D# x15, D# x16) = DoubleX16 (packDoubleX4# (# x1, x2, x3, x4 #)) (packDoubleX4# (# x5, x6, x7, x8 #)) (packDoubleX4# (# x9, x10, x11, x12 #)) (packDoubleX4# (# x13, x14, x15, x16 #))
...
unpackDoubleX16 (DoubleX16 m1 m2 m3 m4) = case unpackDoubleX4# m1 of
    (# x1, x2, x3, x4 #) -> case unpackDoubleX4# m2 of
        (# x5, x6, x7, x8 #) -> case unpackDoubleX4# m3 of
            (# x9, x10, x11, x12 #) -> case unpackDoubleX4# m4 of
                (# x13, x14, x15, x16 #) -> (D# x1, D# x2, D# x3, D# x4, D# x5, D# x6, D# x7, D# x8, D# x9, D# x10, D# x11, D# x12, D# x13, D# x14, D# x15, D# x16)

{-# INLINE unsafeInsertDoubleX16 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertDoubleX16 :: DoubleX16 -> Double -> Int -> DoubleX16
unsafeInsertDoubleX16 (DoubleX16 m1 m2 m3 m4) (D# y) _i@(I# ip) | _i < 4 = DoubleX16 (insertDoubleX4# m1 y (ip -# 0#)) m2 m3 m4
                                                                | _i < 8 = DoubleX16 m1 (insertDoubleX4# m2 y (ip -# 4#)) m3 m4
                                                                | _i < 12 = DoubleX16 m1 m2 (insertDoubleX4# m3 y (ip -# 8#)) m4
                                                                | otherwise = DoubleX16 m1 m2 m3 (insertDoubleX4# m4 y (ip -# 12#))
...
sumDoubleX16 (DoubleX16 x1 x2 x3 x4) = case unpackDoubleX4# (plusDoubleX4# x1 (plusDoubleX4# x2 (plusDoubleX4# x3 x4))) of
    (# y1, y2, y3, y4 #) -> D# y1 + D# y2 + D# y3 + D# y4

{-# INLINE plusDoubleX16 #-}
-- | Add two vectors element-wise.
plusDoubleX16 :: DoubleX16 -> DoubleX16 -> DoubleX16
plusDoubleX16 (DoubleX16 m1_1 m2_1 m3_1 m4_1) (DoubleX16 m1_2 m2_2 m3_2 m4_2) = DoubleX16 (plusDoubleX4# m1_1 m1_2) (plusDoubleX4# m2_1 m2_2) (plusDoubleX4# m3_1 m3_2) (plusDoubleX4# m4_1 m4_2)

{-# INLINE minusDoubleX16 #-}
-- | Subtract two vectors element-wise.
minusDoubleX16 :: DoubleX16 -> DoubleX16 -> DoubleX16
minusDoubleX16 (DoubleX16 m1_1 m2_1 m3_1 m4_1) (DoubleX16 m1_2 m2_2 m3_2 m4_2) = DoubleX16 (minusDoubleX4# m1_1 m1_2) (minusDoubleX4# m2_1 m2_2) (minusDoubleX4# m3_1 m3_2) (minusDoubleX4# m4_1 m4_2)

{-# INLINE timesDoubleX16 #-}
-- | Multiply two vectors element-wise.
timesDoubleX16 :: DoubleX16 -> DoubleX16 -> DoubleX16
timesDoubleX16 (DoubleX16 m1_1 m2_1 m3_1 m4_1) (DoubleX16 m1_2 m2_2 m3_2 m4_2) = DoubleX16 (timesDoubleX4# m1_1 m1_2) (timesDoubleX4# m2_1 m2_2) (timesDoubleX4# m3_1 m3_2) (timesDoubleX4# m4_1 m4_2)

{-# INLINE divideDoubleX16 #-}
-- | Divide two vectors element-wise.
divideDoubleX16 :: DoubleX16 -> DoubleX16 -> DoubleX16
divideDoubleX16 (DoubleX16 m1_1 m2_1 m3_1 m4_1) (DoubleX16 m1_2 m2_2 m3_2 m4_2) = DoubleX16 (divideDoubleX4# m1_1 m1_2) (divideDoubleX4# m2_1 m2_2) (divideDoubleX4# m3_1 m3_2) (divideDoubleX4# m4_1 m4_2)

{-# INLINE negateDoubleX16 #-}
-- | Negate element-wise.
negateDoubleX16 :: DoubleX16 -> DoubleX16
negateDoubleX16 (DoubleX16 m1_1 m2_1 m3_1 m4_1) = DoubleX16 (negateDoubleX4# m1_1) (negateDoubleX4# m2_1) (negateDoubleX4# m3_1) (negateDoubleX4# m4_1)

{-# INLINE indexDoubleX16Array #-}
-- | Read a vector from specified index of the immutable array.
indexDoubleX16Array :: ByteArray -> Int -> DoubleX16
indexDoubleX16Array (ByteArray a) (I# i) = DoubleX16 (indexDoubleX4Array# a ((i *# 4#) +# 0#)) (indexDoubleX4Array# a ((i *# 4#) +# 1#)) (indexDoubleX4Array# a ((i *# 4#) +# 2#)) (indexDoubleX4Array# a ((i *# 4#) +# 3#))

{-# INLINE readDoubleX16Array #-}
-- | Read a vector from specified index of the mutable array.
readDoubleX16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m DoubleX16
readDoubleX16Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readDoubleX4Array# a ((i *# 4#) +# 0#) s0 of
    (# s1, m1 #) -> case readDoubleX4Array# a ((i *# 4#) +# 1#) s1 of
        (# s2, m2 #) -> case readDoubleX4Array# a ((i *# 4#) +# 2#) s2 of
            (# s3, m3 #) -> case readDoubleX4Array# a ((i *# 4#) +# 3#) s3 of
                (# s4, m4 #) -> (# s4, DoubleX16 m1 m2 m3 m4 #))

{-# INLINE writeDoubleX16Array #-}
-- | Write a vector to specified index of mutable array.
writeDoubleX16Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> DoubleX16 -> m ()
writeDoubleX16Array (MutableByteArray a) (I# i) (DoubleX16 m1 m2 m3 m4) = primitive_ (writeDoubleX4Array# a ((i *# 4#) +# 0#) m1) >> primitive_ (writeDoubleX4Array# a ((i *# 4#) +# 1#) m2) >> primitive_ (writeDoubleX4Array# a ((i *# 4#) +# 2#) m3) >> primitive_ (writeDoubleX4Array# a ((i *# 4#) +# 3#) m4)

{-# INLINE indexDoubleX16OffAddr #-}
-- | Reads vector from the specified index of the address.
indexDoubleX16OffAddr :: Addr -> Int -> DoubleX16
indexDoubleX16OffAddr (Addr a) (I# i) = DoubleX16 (indexDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 0#)) 0#) (indexDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 32#)) 0#) (indexDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 64#)) 0#) (indexDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 96#)) 0#)

{-# INLINE readDoubleX16OffAddr #-}
-- | Reads vector from the specified index of the address.
readDoubleX16OffAddr :: PrimMonad m => Addr -> Int -> m DoubleX16
readDoubleX16OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readDoubleX4OffAddr# (plusAddr# addr i') 0#) a ((i *# 128#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readDoubleX4OffAddr# (plusAddr# addr i') 0#) a ((i *# 128#) +# 32#) s1 of
        (# s2, m2 #) -> case (\ addr i' -> readDoubleX4OffAddr# (plusAddr# addr i') 0#) a ((i *# 128#) +# 64#) s2 of
            (# s3, m3 #) -> case (\ addr i' -> readDoubleX4OffAddr# (plusAddr# addr i') 0#) a ((i *# 128#) +# 96#) s3 of
                (# s4, m4 #) -> (# s4, DoubleX16 m1 m2 m3 m4 #))

{-# INLINE writeDoubleX16OffAddr #-}
-- | Write vector to the specified index of the address.
writeDoubleX16OffAddr :: PrimMonad m => Addr -> Int -> DoubleX16 -> m ()
writeDoubleX16OffAddr (Addr a) (I# i) (DoubleX16 m1 m2 m3 m4) = primitive_ (writeDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 0#)) 0# m1) >> primitive_ (writeDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 32#)) 0# m2) >> primitive_ (writeDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 64#)) 0# m3) >> primitive_ (writeDoubleX4OffAddr# (plusAddr# a ((i *# 128#) +# 96#)) 0# m4)
