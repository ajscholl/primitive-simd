...
-- ** Int32X8
data Int32X8 = Int32X8 Int32X4# Int32X4# deriving Typeable
...
packInt32X8 (I32# x1, I32# x2, I32# x3, I32# x4, I32# x5, I32# x6, I32# x7, I32# x8) = Int32X8 (packInt32X4# (# x1, x2, x3, x4 #)) (packInt32X4# (# x5, x6, x7, x8 #))

{-# INLINE unpackInt32X8 #-}
-- | Unpack the elements of a vector into a tuple.
unpackInt32X8 :: Int32X8 -> (Int32, Int32, Int32, Int32, Int32, Int32, Int32, Int32)
unpackInt32X8 (Int32X8 m1 m2) = case unpackInt32X4# m1 of
    (# x1, x2, x3, x4 #) -> case unpackInt32X4# m2 of
        (# x5, x6, x7, x8 #) -> (I32# x1, I32# x2, I32# x3, I32# x4, I32# x5, I32# x6, I32# x7, I32# x8)

{-# INLINE unsafeInsertInt32X8 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertInt32X8 :: Int32X8 -> Int32 -> Int -> Int32X8
unsafeInsertInt32X8 (Int32X8 m1 m2) (I32# y) _i@(I# ip) | _i < 4 = Int32X8 (insertInt32X4# m1 y (ip -# 0#)) m2
                                                        | otherwise = Int32X8 m1 (insertInt32X4# m2 y (ip -# 4#))
...
{-# RULES "foldVector (+)" foldInt32X8 (+) = sumVector #-}

{-# INLINE sumInt32X8 #-}
-- | Sum up the elements of a vector to a single value.
sumInt32X8 :: Int32X8 -> Int32
sumInt32X8 (Int32X8 x1 x2) = case unpackInt32X4# (plusInt32X4# x1 x2) of
    (# y1, y2, y3, y4 #) -> I32# y1 + I32# y2 + I32# y3 + I32# y4

{-# INLINE plusInt32X8 #-}
-- | Add two vectors element-wise.
plusInt32X8 :: Int32X8 -> Int32X8 -> Int32X8
plusInt32X8 (Int32X8 m1_1 m2_1) (Int32X8 m1_2 m2_2) = Int32X8 (plusInt32X4# m1_1 m1_2) (plusInt32X4# m2_1 m2_2)

{-# INLINE minusInt32X8 #-}
-- | Subtract two vectors element-wise.
minusInt32X8 :: Int32X8 -> Int32X8 -> Int32X8
minusInt32X8 (Int32X8 m1_1 m2_1) (Int32X8 m1_2 m2_2) = Int32X8 (minusInt32X4# m1_1 m1_2) (minusInt32X4# m2_1 m2_2)

{-# INLINE timesInt32X8 #-}
-- | Multiply two vectors element-wise.
timesInt32X8 :: Int32X8 -> Int32X8 -> Int32X8
timesInt32X8 (Int32X8 m1_1 m2_1) (Int32X8 m1_2 m2_2) = Int32X8 (timesInt32X4# m1_1 m1_2) (timesInt32X4# m2_1 m2_2)

{-# INLINE quotInt32X8 #-}
-- | Rounds towards zero element-wise.
quotInt32X8 :: Int32X8 -> Int32X8 -> Int32X8
quotInt32X8 (Int32X8 m1_1 m2_1) (Int32X8 m1_2 m2_2) = Int32X8 (quotInt32X4# m1_1 m1_2) (quotInt32X4# m2_1 m2_2)

{-# INLINE remInt32X8 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt32X8 :: Int32X8 -> Int32X8 -> Int32X8
remInt32X8 (Int32X8 m1_1 m2_1) (Int32X8 m1_2 m2_2) = Int32X8 (remInt32X4# m1_1 m1_2) (remInt32X4# m2_1 m2_2)

{-# INLINE negateInt32X8 #-}
-- | Negate element-wise.
negateInt32X8 :: Int32X8 -> Int32X8
negateInt32X8 (Int32X8 m1_1 m2_1) = Int32X8 (negateInt32X4# m1_1) (negateInt32X4# m2_1)

{-# INLINE indexInt32X8Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt32X8Array :: ByteArray -> Int -> Int32X8
indexInt32X8Array (ByteArray a) (I# i) = Int32X8 (indexInt32X4Array# a ((i *# 2#) +# 0#)) (indexInt32X4Array# a ((i *# 2#) +# 1#))

{-# INLINE readInt32X8Array #-}
-- | Read a vector from specified index of the mutable array.
readInt32X8Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int32X8
readInt32X8Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt32X4Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readInt32X4Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Int32X8 m1 m2 #))

{-# INLINE writeInt32X8Array #-}
-- | Write a vector to specified index of mutable array.
writeInt32X8Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int32X8 -> m ()
writeInt32X8Array (MutableByteArray a) (I# i) (Int32X8 m1 m2) = primitive_ (writeInt32X4Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeInt32X4Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexInt32X8OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt32X8OffAddr :: Addr -> Int -> Int32X8
indexInt32X8OffAddr (Addr a) (I# i) = Int32X8 (indexInt32X4OffAddr# (plusAddr# a ((i *# 32#) +# 0#)) 0#) (indexInt32X4OffAddr# (plusAddr# a ((i *# 32#) +# 16#)) 0#)

{-# INLINE readInt32X8OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt32X8OffAddr :: PrimMonad m => Addr -> Int -> m Int32X8
readInt32X8OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt32X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 32#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readInt32X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 32#) +# 16#) s1 of
        (# s2, m2 #) -> (# s2, Int32X8 m1 m2 #))

{-# INLINE writeInt32X8OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt32X8OffAddr :: PrimMonad m => Addr -> Int -> Int32X8 -> m ()
writeInt32X8OffAddr (Addr a) (I# i) (Int32X8 m1 m2) = primitive_ (writeInt32X4OffAddr# (plusAddr# a ((i *# 32#) +# 0#)) 0# m1) >> primitive_ (writeInt32X4OffAddr# (plusAddr# a ((i *# 32#) +# 16#)) 0# m2)
